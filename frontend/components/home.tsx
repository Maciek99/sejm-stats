...
const Home: React.FC<HomeProps> = ({ latestVotings, allClubs, cards }) => {
  return (
    <div className="container min-w-full px-0 mx-auto">
      <div
        className={`relative overflow-hidden ${styles.bgBanner} border-b py-16 lg:px-12 sm:px-1 `}
      >
        <div className="mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-md mb-8">
            <div className="flex">
              ...
              />
              <button className="bg-blue-500 text-foreground px-4 py-2 rounded-r-lg">
                <FaSearch />
              </button>
            </div>
          </div>
          <div className="flex space-x-4">
            <Button
              className="bg-blue-500 text-foreground px-6 py-2 rounded hover:bg-blue-600 transition"
            >
              <Link
                href="/envoys"
              >
            ...
            <Button
              variant="outline"
              className=" text-blue-500 border border-blue-500 px-6 py-2 rounded transition"
              asChild>
              <Link
                href="/faq"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 px-4 max-w-7xl mx-auto">
        <div>
          <h2 className="text-4xl text-secondary-foreground mb-4">Statystyki</h2>
        ...
        <div>
          <h2 className="text-4xl text-secondary-foreground  mb-4">
            Ostatnie Głosowania
          </h2>
      ...
      <div className=" max-w-7xl px-4 mx-auto">
        <h1 className="text-5xl text-secondary-foreground  mt-8 mb-4">Aktualności</h1>
        <hr className="my-4" />
        <section
          id="articles"
